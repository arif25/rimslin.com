    ...
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/80 bg-white/90 dark:border-gulf-500/20 dark:bg-[#060b08]/95 backdrop-blur-md shadow-sm dark:shadow-lg dark:shadow-black/20 transition-colors duration-200">
      ...
      <div className="mx-auto flex h-16 sm:h-18 max-w-7xl w-full items-center justify-between px-3 sm:px-6 lg:px-8 min-w-0">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 min-w-0">
          ...
          {/* 2. Official Support Email Link (Desktop & Tablet) */}
          <a
            href="mailto:support@rimslin.com"
            className="hidden md:inline-flex items-center gap-1.5 rounded-xl border border-slate-200/80 bg-white/90 text-slate-700 hover:border-emerald-500 hover:bg-slate-100 hover:text-emerald-700 dark:border-white/10 dark:bg-surface-100/90 dark:text-slate-200 dark:hover:border-gulf-500/40 dark:hover:bg-surface-200 dark:hover:text-gulf-300 px-2.5 py-1.5 sm:px-3 sm:py-2 text-xs font-semibold transition-colors shadow-sm shrink-0"
          ...
          >
            ...
            <span className="font-mono text-[11px] sm:text-xs">support@rimslin.com</span>
          </a>

          {/* 3. Direct WhatsApp Helpline Button */}
          <Link
            href={whatsappUrl}
            target="_blank"
            rel="noreferrer"
      ...
      <div className="w-full border-t border-b border-slate-200/80 bg-white dark:border-gulf-500/20 dark:bg-[#07130b] transition-colors duration-200 relative z-40">
            ...
            {isMoreOpen && (
              ...
              >
                <div className="px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 border-b border-slate-100 dark:border-white/[0.08] mb-1.5 flex items-center justify-between">
                  <span>{t.navbar.more}</span>
                  <span className="text-amber-600 dark:text-gold-400 font-mono text-[9px] font-semibold">7 Resources</span>
                </div>
                ...
                {/* Need help? Email us (Mobile & Desktop Drawer) */}
