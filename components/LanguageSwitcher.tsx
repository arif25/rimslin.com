            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center rounded-xl py-2 px-1 text-xs font-bold transition-all ${
                  isActive
                    ? "bg-gradient-to-r from-gulf-600 to-emerald-600 text-white shadow-md shadow-gulf-600/30 ring-1 ring-gulf-400/50"
                    : "border border-white/10 bg-surface-100 text-slate-300 hover:bg-surface-200 hover:text-white"
                }`}
              >
      ...
      {isOpen && (
        ...
        >
          <div className="px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-400 border-b border-white/[0.06] mb-1 flex items-center justify-between">
            ...
            <span className="text-gold-400 font-mono text-[9px]">4 Languages</span>
          </div>
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center justify-between rounded-xl px-3 py-2 text-xs font-semibold transition-all ${
                    isSelected
                      ? "bg-gulf-500/20 text-gulf-300 font-bold border border-gulf-500/40"
                      : "text-slate-200 hover:bg-surface-200 hover:text-white"
                  }`}
                >
                  ...
                  {isSelected && (
                    <Check className="h-4 w-4 text-gulf-400 shrink-0" />
                  )}
                </button>
              );
            })}
