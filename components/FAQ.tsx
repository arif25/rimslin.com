...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="relative scroll-mt-28 sm:scroll-mt-32 overflow-hidden w-full max-w-full py-6 sm:py-10 md:py-14 bg-slate-50 border-t border-slate-200/80 dark:bg-[#060e09] dark:border-gulf-500/20 transition-colors duration-200">
      <div className="mx-auto max-w-5xl w-full px-4 sm:px-6 lg:px-8 min-w-0">
        ...
        {/* Accordion */}
        <div className="mt-6 sm:mt-10 md:mt-14 space-y-2.5 sm:space-y-4 w-full max-w-full min-w-0">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="flex w-full items-center justify-between gap-4 p-3.5 sm:p-5 md:p-6 text-left"
                ...
                {isOpen && (
                  <div className="px-3.5 pb-4 sm:px-6 sm:pb-6 text-sm text-slate-600 dark:text-slate-300 leading-relaxed border-t border-slate-100 dark:border-white/[0.06] pt-3.5 sm:pt-4 animate-fade-in">
                    {faq.answer}
                  </div>
                )}
              </div>
        ...
        <div className="mt-6 sm:mt-10 md:mt-12 text-center rounded-2xl border border-slate-200 bg-white/80 dark:border-white/[0.08] dark:bg-surface-100/40 p-4 sm:p-6 shadow-sm">
