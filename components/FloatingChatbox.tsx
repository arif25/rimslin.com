  ...
  return (
    <div ref={chatboxRef} className="select-none">
      ...
      <div
        ...
        className={`fixed z-50 bottom-20 inset-x-4 sm:inset-x-auto sm:right-5 w-auto sm:w-[410px] h-[565px] max-h-[85vh] rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden flex flex-col transition-all duration-300 ease-out ${
          isOpen
