      ...
      <main className="flex-1 min-h-screen bg-slate-50 py-6 sm:py-10 md:py-12 px-4 sm:px-6 lg:px-8 dark:bg-[#060b08]">
        <div className="max-w-6xl mx-auto space-y-6 sm:space-y-10">
          ...
          <div className="text-center">
            ...
            {/* Rating Summary Bar */}
            <div className="mt-4 sm:mt-6 inline-flex flex-wrap items-center justify-center gap-3 sm:gap-4 bg-white dark:bg-surface-100 border border-slate-200 dark:border-white/10 rounded-2xl px-3.5 py-2 sm:px-6 sm:py-3 shadow-xs">
